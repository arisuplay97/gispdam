                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className={`flex items-center gap-2 mb-1 ${isAIPowered ? "text-white/60" : darkMode ? "text-gray-500" : "text-gray-400"}`}>
                          <span className="text-[10px] font-bold uppercase tracking-widest">{isAIPowered ? "Groq AI · GPT-OSS 120B" : "Analisis Sistem"}</span>
                        ...
                        {isAIPowered && !isAILoading && (
                          <p className={`text-[11px] mt-2 italic text-white/40`}>
                            Prediksi grafik dihitung oleh <span className="font-semibold not-italic">AI GPT-OSS 120B</span>
                          </p>
                        )}
                      </div>
                    </div>
