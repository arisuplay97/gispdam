      ...
      {!showLegend ? (
        ...
        <div className="absolute bottom-6 left-6 z-[1000] rounded-xl border border-slate-200 bg-white/95 p-4 shadow-lg backdrop-blur-sm" style={{ minWidth: 220 }}>
          ...
          <div className="space-y-1 text-xs">
            {([
              { key: "valves",       label: "Valve",                swatch: <span className="inline-flex shrink-0"><svg width="22" height="26" viewBox="0 0 60 68" fill="none"><rect x="4" y="26" width="52" height="14" rx="7" fill="#ffedd5" stroke="#ea580c" strokeWidth="3"/><circle cx="30" cy="33" r="13" fill="#ffedd5" stroke="#ea580c" strokeWidth="3"/><line x1="30" y1="20" x2="30" y2="33" stroke="#ea580c" strokeWidth="4" strokeLinecap="round"/></svg></span> },
              { key: "sources",      label: "Sumber Air",           swatch: <span className="inline-flex shrink-0"><svg width="22" height="26" viewBox="0 0 60 68" fill="none"><path d="M8 20 Q30 4 52 20Z" fill="#7c3aed"/><rect x="8" y="20" width="44" height="26" fill="#ddd6fe" stroke="#7c3aed" strokeWidth="3"/><ellipse cx="30" cy="46" rx="22" ry="6" fill="#7c3aed"/></svg></span> },
              ...
              { key: "monitoring",   label: "Titik Monitoring",     swatch: <span className="inline-flex shrink-0"><svg width="22" height="26" viewBox="0 0 60 68" fill="none"><ellipse cx="30" cy="10" rx="22" ry="6" fill="#22c55e"/><rect x="8" y="10" width="44" height="36" fill="#bbf7d0" stroke="#16a34a" strokeWidth="3"/><circle cx="30" cy="30" r="12" fill="#16a34a"/><ellipse cx="30" cy="46" rx="22" ry="6" fill="#16a34a"/></svg></span> },
