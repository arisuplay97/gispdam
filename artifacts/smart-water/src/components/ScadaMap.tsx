      ...
      {!showLegend ? (
        ...
        <div className="absolute bottom-6 left-6 z-[1000] rounded-xl border border-slate-200 bg-white/95 p-4 shadow-lg backdrop-blur-sm" style={{ minWidth: 220 }}>
          ...
          <div className="space-y-1 text-xs">
            {([
              { key: "valves",       label: "Valve",                swatch: <span className="inline-flex shrink-0"><svg width="18" height="20" viewBox="0 0 40 46" fill="none"><polygon points="20,7 33.8,15 33.8,31 20,39 6.2,31 6.2,15" fill="#dcfce7" stroke="#16a34a" strokeWidth="2" strokeLinejoin="round"/><polygon points="20,11 30.4,17 30.4,29 20,35 9.6,29 9.6,17" fill="#bbf7d0" opacity="0.8"/><text x="20" y="27" textAnchor="middle" fill="#16a34a" fontSize="10" fontWeight="900" fontFamily="monospace" letterSpacing="-0.5">VAL</text></svg></span> },
